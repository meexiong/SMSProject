...
public class FrmReportStdPayment extends javax.swing.JFrame {
    Connection c = DatabaseManagerSQL.getConnection();
    Map<String, Object[]> mapSemester=null;
    String frm;
    public FrmReportStdPayment() {
        initComponents();
    ...
    private void btnMinimizeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnMinimizeMouseClicked
        this.setState(FrmReportStdPayment.ICONIFIED);
        ...
        try {
            if (evt.getModifiers() == 6) {
                ...
                if ("L1".equals(LangType)) {
                    pri = JasperFillManager.fillReport("src/com/malimar/reports/ReportPayment_L1.jasper", param, c);
                } else {
                    pri = JasperFillManager.fillReport("src/com/malimar/reports/ReportPayment_L2.jasper", param, c);
                }
                FrmOpenReport f = new FrmOpenReport();
                f.setExtendedState(JFrame.MAXIMIZED_BOTH);
                f.setTitle("Student Payments Report");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmReportStdPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmReportStdPayment().setVisible(true);
            }
        });
    }
