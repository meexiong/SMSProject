...
public class FrmReportSaleByDate extends javax.swing.JFrame {
        ...
        try {
            if (evt.getModifiers() == 6) {
                ...
                if ("L1".equals(LangType)) {
                    pri = JasperFillManager.fillReport("src/com/malimar/reports/ReportSaleByDate_L1.jasper", param, c);
                } else {
                    pri = JasperFillManager.fillReport("src/com/malimar/reports/ReportSaleByDate_L2.jasper", param, c);
                }
                if (!pri.getPages().isEmpty()) {
                    FrmOpenReport f = new FrmOpenReport();
                    f.setExtendedState(JFrame.MAXIMIZED_BOTH);
                    f.setTitle("Sale Report By Date");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmReportSaleByDate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmReportSaleByDate().setVisible(true);
            }
        });
    }
