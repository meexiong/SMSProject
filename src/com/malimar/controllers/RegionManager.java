...
public class RegionManager {
    ...
    public boolean insertRegion(Region rg){
        try {
            ...
            sql = "Insert into tbl_Religion (REID, re_name_l1, re_name_l2) values (?,?,?)";
    ...
    public boolean updateRegion(Region rg){
        try {
            sql = "Update tbl_Religion set Re_name_l1 = ?, Re_name_L2 =? where REID= (?)";
            PreparedStatement p = c.prepareStatement(sql);
    ...
    public void showData(JTable jtable, DefaultTableModel model){
        try {
            ...
            sql = "Select * from tbl_Religion order by REID desc";
